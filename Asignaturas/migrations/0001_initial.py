# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-20 03:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='oferta',
            name='profesor',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='Asignaturas.Profesor'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='oferta',
            unique_together=set([('materia', 'profesor')]),
        ),
    ]
