...
urlpatterns = [
	...
	url(r'tabla-oferta-dpto/$', views.tablaOfertaDpto, name='ofertaDpto'),
	...
	url(r'modificar-oferta-dpto/(?P<id>[0-9]*)/$', views.modificarOfertaDpto, name='modificarOfertaDpto'),
	url(r'preferencias-prof/(?P<ci>[0-9]{6,12})/$', views.seleccionMatProfesores, name='preferencias'),
	url(r'oferta-coord/(?P<id>[0-9]*)/$', views.ofertaCoord, name='oferta-coord'),
